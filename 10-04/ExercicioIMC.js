...
else if(calculo = 18){ console.log ("Você está abaixo do peso")}
else if(calculo > 25){ console.log("Você está acima do peso")}
else if(calculo > 30){ console.log("Você tem obesidade nivel I")}
